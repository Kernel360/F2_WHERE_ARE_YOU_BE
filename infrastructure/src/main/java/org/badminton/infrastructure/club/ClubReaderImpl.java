...
public class ClubReaderImpl implements ClubReader {
	...
	public List<ClubCardInfo> readRecentlyCreatedClubs() {
		...
		return retrieveAndCacheTop10Clubs();

	}

	@Override
	@Transactional(readOnly = true)
	public List<ClubCardInfo> retrieveAndCacheTop10Clubs() {
		...
		redisTemplate.opsForValue().set(RECENTLY_TOP10_REDIS_KEY, clubCardInfos);
