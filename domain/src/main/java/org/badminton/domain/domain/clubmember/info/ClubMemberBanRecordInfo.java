...
public record ClubMemberBanRecordInfo(
	...
	public static ClubMemberBanRecordInfo fromClubMember(ClubMemberBanRecord clubMemberBanRecord) {
		return new ClubMemberBanRecordInfo(clubMemberBanRecord.getBannedType(), clubMemberBanRecord.getBannedReason(),
			clubMemberBanRecord.getClubMember().getClubMemberId(), clubMemberBanRecord.isActive(),
			clubMemberBanRecord.getEndDate());
	}
}
