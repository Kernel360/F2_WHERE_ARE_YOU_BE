...
//
// 	@Mock
// 	private ClubMemberPolicy clubMemberPolicy;
//
// 	@BeforeEach
// 	void setUp() {
...
// 		when(clubService.updateClub(clubUpdateCommand, clubToken, memberToken)).thenReturn(mockUpdateInfo);
//
// 		// Act
// 		ClubUpdateInfo result = clubFacade.updateClubInfo(clubUpdateCommand, clubToken, memberToken);
//
// 		// Assert
// 		assertNotNull(result);
// 		verify(clubService, times(1)).updateClub(clubUpdateCommand, clubToken, memberToken);
// 	}
//
// 	@Test
...
// 		doNothing().when(clubMemberPolicy).validateClubOwner(memberToken, clubToken);
// 		when(clubService.deleteClub(clubToken)).thenReturn(mockDeleteInfo);
//
// 		// Act
// 		ClubDeleteInfo result = clubFacade.deleteClubInfo(clubToken, memberToken);
//
// 		// Assert
// 		assertNotNull(result);
...
//
// 		// Act
// 		List<ClubApplicantInfo> result = clubFacade.readClubApplicants(clubToken, memberToken);
//
// 		// Assert
// 		assertNotNull(result);
